...
//这是模拟的一个异步方法
var asyncFun = function asyncFun(input, callback) {
    var ms = input * 2000;
    setTimeout(function () {
...
var generator = regeneratorRuntime.mark(function generator(input1, input2) {
    var res1, res2, res3;
    return regeneratorRuntime.wrap(function generator$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.next = 2;
                    return asyncFunThunk(input1);

                case 2:
                    res1 = _context.sent;
                    _context.next = 5;
                    return asyncFunThunk(res1 + input2);

                case 5:
                    res2 = _context.sent;
                    _context.next = 8;
                    return asyncFunThunk(res1 + res2);
...
var generatorRunner = function generatorRunner(generator) {
    var mg = {
        //这个方法就是generator函数的自动执行方法
        start: function start() {
            for (var _len2 = arguments.length, runArgs = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
                runArgs[_key2] = arguments[_key2];
            }
